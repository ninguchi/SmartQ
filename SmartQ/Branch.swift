...
@objc public class Branch : NSObject, CDTDataObject {
    ...
    var bra_ty_a_max : NSNumber = 0
    var bra_ty_a_turnover : NSNumber = 0
    var bra_ty_b_min : NSNumber = 0
    var bra_ty_b_max : NSNumber = 0
    var bra_ty_b_turnover : NSNumber = 0
    var bra_ty_c_min : NSNumber = 0
    var bra_ty_c_max : NSNumber = 0
    var bra_ty_c_turnover : NSNumber = 0
    var bra_ty_d_min : NSNumber = 0
    var bra_ty_d_max : NSNumber = 0
    var bra_ty_d_turnover : NSNumber = 0
